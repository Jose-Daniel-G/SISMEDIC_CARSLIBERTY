...
class ConsultorioController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('doctor.consultorios.index', compact('consultorios'));
    }
    ...
    {
        return view('doctor.consultorios.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('doctor.consultorios.index')
    ...
    public function show($id)
    {
        ...
        return view('doctor.consultorios.show', compact('consultorio'));
    }
    ...
    {
        $consultorio = Consultorio::findOrFail($id);
        return view('doctor.consultorios.edit', compact('consultorio'));
    }
    ...
    public function confirmDelete($id){
        $consultorio = Consultorio::findOrFail($id);
        return view('doctor.consultorios.delete', compact('consultorio'));
    }
